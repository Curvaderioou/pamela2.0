...
// Mudar Aqui o e-mail
$email_envio = "agendapsi@pamelapauls.psc.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "1737011a"; // Senha do e-mail

$site_name = "Pamela Pauls - Psicóloga/Psicanalista"; // Nome do Site
$site_url = "www.pamelapauls.psc.br"; // URL do Site
$host_smtp = "pamelapauls.psc.br"; // HOST SMTP Ex: smtp.domain.com.br
